// -------------------------------------------------------------
// 
// File Name: D:\КЕОА\3 курс\Апараткі\Лаба №2\Lab2_1(second try)\Lab2_1\Sqrt.v
...
// 
// Module: Sqrt
// Source Path: Lab2_1/CALC_MAGNITUDE_AND_PHASE_FIXED_POINT/Sqrt
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Sqrt
  ...
  input   reset;
  input   enb;
  input   [64:0] din;  // ufix65_En24
  output  [32:0] dout;  // ufix33_En12


  wire [1:0] Root_Square0_temp1;  // ufix2
  wire [65:0] resizedin;  // ufix66_En24
  ...
  wire [63:0] Root_Square31_temp0;  // ufix64
  wire [63:0] Root_Square31;  // ufix64
  reg [63:0] currentRoot_Square32_p;  // ufix64
  wire [1:0] constant_032;  // ufix2
  wire [65:0] prevRoot_Square_extend32;  // ufix66
  wire [1:0] constant_032_1;  // ufix2
  wire [33:0] prevRoot_extend32;  // ufix34
  wire [66:0] adder_add_temp_31;  // ufix67
  wire [66:0] adder_94;  // ufix67
  wire [66:0] adder_95;  // ufix67
  wire [65:0] Root_Square32_temp1;  // ufix66
  reg [65:0] resizedin32_p;  // ufix66
  wire relop_relop1_32;
  wire [32:0] Root_32;  // ufix33
  reg [32:0] currentRoot33_p;  // ufix33
  reg [32:0] prevRoot_p2_reg [0:1];  // ufix33 [2]
  wire [32:0] prevRoot_p2_reg_next [0:1];  // ufix33 [2]
  wire [32:0] prevRoot_p_2;  // ufix33
  wire [32:0] outdata_1;  // ufix33_En12
  ...
  assign din_temp_0 = resizedin_temp[65:64];
  ...
  assign din_temp_1 = resizedin1_p[65:62];
  ...
  assign din_temp_2 = resizedin2_p[65:60];
  ...
  assign din_temp_3 = resizedin3_p[65:58];
  ...
  assign din_temp_4 = resizedin4_p[65:56];
  ...
  assign din_temp_5 = resizedin5_p[65:54];
  ...
  assign din_temp_6 = resizedin6_p[65:52];
  ...
  assign din_temp_7 = resizedin7_p[65:50];
  ...
  assign din_temp_8 = resizedin8_p[65:48];
  ...
  assign din_temp_9 = resizedin9_p[65:46];
  ...
  assign din_temp_10 = resizedin10_p[65:44];
  ...
  assign din_temp_11 = resizedin11_p[65:42];
  ...
  assign din_temp_12 = resizedin12_p[65:40];
  ...
  assign din_temp_13 = resizedin13_p[65:38];
  ...
  assign din_temp_14 = resizedin14_p[65:36];
  ...
  assign din_temp_15 = resizedin15_p[65:34];
  ...
  assign din_temp_16 = resizedin16_p[65:32];
  ...
  assign din_temp_17 = resizedin17_p[65:30];
  ...
  assign din_temp_18 = resizedin18_p[65:28];
  ...
  assign din_temp_19 = resizedin19_p[65:26];
  ...
  assign din_temp_20 = resizedin20_p[65:24];
  ...
  assign din_temp_21 = resizedin21_p[65:22];
  ...
  assign din_temp_22 = resizedin22_p[65:20];
  ...
  assign din_temp_23 = resizedin23_p[65:18];
  ...
  assign din_temp_24 = resizedin24_p[65:16];
  ...
  assign din_temp_25 = resizedin25_p[65:14];
  ...
  assign din_temp_26 = resizedin26_p[65:12];
  ...
  assign din_temp_27 = resizedin27_p[65:10];
  ...
  assign din_temp_28 = resizedin28_p[65:8];
  ...
  assign din_temp_29 = resizedin29_p[65:6];
  ...
  assign din_temp_30 = resizedin30_p[65:4];
  ...
  assign din_temp_31 = resizedin31_p[65:2];
  ...
  assign Root_Square31_temp0 = {currentRoot_Square31_p, constant_031_1};



  assign Root_Square31 = (relop_relop1_31 == 1'b0 ? Root_Square31_temp0 :
              Root_Square31_temp1);



  always @(posedge clk or posedge reset)
    begin : root_sq_p_reg_31_process
      if (reset == 1'b1) begin
        currentRoot_Square32_p <= 64'h0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign constant_032 = 2'b01;



  assign prevRoot_Square_extend32 = {currentRoot_Square32_p, constant_032};



  assign constant_032_1 = 2'b00;



  assign prevRoot_extend32 = {currentRoot32_p, constant_032_1};



  assign adder_94 = {1'b0, prevRoot_Square_extend32};
  assign adder_95 = {33'b0, prevRoot_extend32};
  assign adder_add_temp_31 = adder_94 + adder_95;
  assign Root_Square32_temp1 = (adder_add_temp_31[66] != 1'b0 ? 66'h3FFFFFFFFFFFFFFFF :
              adder_add_temp_31[65:0]);



  always @(posedge clk or posedge reset)
    begin : resizedin_reg_31_process
      if (reset == 1'b1) begin
        resizedin32_p <= 66'h00000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign relop_relop1_32 = Root_Square32_temp1 <= resizedin32_p;



  assign Root_32 = {currentRoot32_p, relop_relop1_32};



  always @(posedge clk or posedge reset)
    begin : root_reg_32_process
      if (reset == 1'b1) begin
        currentRoot33_p <= 33'h000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk or posedge reset)
    begin : prevRoot_p2_process
      if (reset == 1'b1) begin
        prevRoot_p2_reg[0] <= 33'h000000000;
        prevRoot_p2_reg[1] <= 33'h000000000;
      end
      else begin
        if (enb) begin
  ...
  assign prevRoot_p2_reg_next[0] = currentRoot33_p;
  assign prevRoot_p2_reg_next[1] = prevRoot_p2_reg[0];



  assign outdata_1 = prevRoot_p_2;
